...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.nestor.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".nestor") // name of config file (without extension)
